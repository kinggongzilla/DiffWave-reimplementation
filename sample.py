...
from source.model_constants import NUM_BLOCKS, RES_CHANNELS, TIME_STEPS, VARIANCE_SCHEDULE, LAYER_WIDTH, SAMPLE_RATE
...
noise = torch.randn(1, 1, SAMPLE_RATE*5) # 22KHz * 5000 milliseconds = 5 seconds of noise
